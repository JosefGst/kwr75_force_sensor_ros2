...
def generate_launch_description():
    ...
    declared_arguments.append(
        DeclareLaunchArgument(
            ...
            default_value='false',
            description='Enable mocked command interfaces for sensors used for '
                        "simple simulations. Used only if 'use_mock_hardware' parameter is true.",
        )
    )
    ...
    inactive_spawners = [
        controller_spawner(
            controller,
            '--inactive') for controller in inactive_list]
